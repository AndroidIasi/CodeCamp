...
public class DummyRepository implements IAgendaDataSource<Long> {
    ...
    public DummyRepository(){
        ...
        this.mRoomsList.add(new DataRoom(-1,"code", "Everywhere", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 1", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 2", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 3", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 4", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 5", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 6", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 7", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 8", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 9", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 10", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 11", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 12", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 13", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 14", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 15", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 16", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 17", "Floor -2, Seats 12"));
        this.mRoomsList.add(new DataRoom(-1,"code", "Room 18", "Floor -2, Seats 12"));

        this.mCodecampersList.add(new DataCodecamper(-1,
                "Bugs Bunny",
                "Rabbit",
                "ACME",
        ...
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Registration", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"MeetTheSponsors", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"MeetTheSponsorsBreak", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"MeetTheSponsorsLine", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Timeslot1", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Timeslot2", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Session2Break", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Timeslot3", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Lunch", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Lunch__", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Timeslot4", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Timeslot5", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Timeslot6", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"Session6Break", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"VipCocktail", new Date(), new Date()));
        this.mTimeFramesList.add(new DataTimeFrame(-1,"AfterParty", new Date(), new Date()));

        this.mSessionsList.add(new DataSession(-1,
                mCodecampersList,
                mRoomsList.get(0),
                "Welcome!",
